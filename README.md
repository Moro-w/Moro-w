...
**AI 产品经理方向｜AI 陪伴 · 内容创作 · Agent 工作流**
...
| 项目 | 解决的问题 | 可以查看的产出 |
| --- | --- | --- |
| 🎹 [复古音乐工作站](https://github.com/Moro-w/retro-music-workstation) | 把自然语言音乐创意变成可生成、可试听、可管理的作品 | [界面预览](https://github.com/Moro-w/retro-music-workstation/blob/main/preview/landing-desktop.png) · [项目概述](https://github.com/Moro-w/retro-music-workstation/blob/main/docs/项目概述_复古音乐工作站.md) |
